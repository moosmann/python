...
# CUDA
proj_id_cu = astra.create_projector('line', proj_geom, vol_geom)
print proj_id_cu
# print 'is cuda: ', astra.projector.is_cuda(matrix_id)

matrix_id_cu = astra.projector.matrix(proj_id_cu)
print matrix_id_cu
# print 'is cuda: ', astra.projector.is_cuda(matrix_id)
W_cu = astra.matrix.get(matrix_id_cu)
...
astra.projector.delete((proj_id, proj_id_cu))
astra.matrix.delete((matrix_id, matrix_id_cu))
